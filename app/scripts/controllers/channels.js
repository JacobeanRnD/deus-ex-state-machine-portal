...
angular.module('deusExStateMachinePortalApp')
  .controller('ChannelsCtrl', function ($rootScope, $timeout, $location, $scope, Session, $state, dataService, username, token) {
    $scope.channels = {
      twitter: {
        status: 'notactive'
      },
      ...
      token: {
        status: token.data ? 'success' : 'notactive'
      }
    };
